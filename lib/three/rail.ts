 ...
 * caméra ne « regarde » jamais un objet, elle suit deux trajectoires, ce qui
 * laisse le contrôle total du cadrage à chaque acte.
 *
 * Les points sont échantillonnés uniformément sur la progression du document,
 * de 0 à 1. Ajouter un acte, c'est ajouter un point à chaque courbe.
 */
const positions = [
