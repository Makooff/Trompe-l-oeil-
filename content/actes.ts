export type ActeId = "seuil" | "vitrine" | "mensonge" | "carte" | "maison";
 ...
 * Les plages sont contiguës et couvrent [0, 1].
 */
export const actes: Acte[] = [
  ...
  },
  {
    ...
    kicker: "Ouvrez-les",
    chapo:
      "Huit pièces, une lame. Glissez-la sur chacune : la coque s'écarte et vous voyez les couches que le faux titre cachait.",
    debut: 0.3,
    fin: 0.76,
  },
  {
